...
field string --named roleKey;
description add-field-description --onProperty roleKey --title "Role Key" --text "Identifier of this role";
description add-field-description --onProperty roleKey --title "Identifiant due role" --text "Identifiant du role." --locale fr;
constraint NotNull --onProperty roleKey;
...
field string --named roleName;
description add-field-description --onProperty roleName --title "Name of the Role" --text "Name of the Role";
description add-field-description --onProperty roleName --title "Nom du Role" --text "Language" --locale fr;
constraint NotNull --onProperty roleName;

field string --named description;
description add-field-description --onProperty description --title "Name of the Role" --text "Name of the Role";
description add-field-description --onProperty description --title "Nom du Role" --text "Language" --locale fr;
constraint NotNull --onProperty description;
constraint Size --onProperty description --max 256;

@/* Enum type Sales Status */;
java new-enum-type --named SlsSalesStatus --package ~.jpa;
...
cd ~~ ;
 ...
 @/* Processing Step */;
java new-enum-type --named ProcStep --package ~.jpa;
enum add-enum-class-description --title "Processing Step" --text "Sales Order Processing Step";
enum add-enum-class-description  --locale fr --title "Etape Execution" --text "Etape d Execution de la Commande Client";
...
cd ~~ ;
 ...
 @/* History Type */;
java new-enum-type --named HistoryType --package ~.jpa;
enum add-enum-class-description --title "Sales Order History Type" --text "Sales Order History Type";
enum add-enum-class-description --locale fr --title "Type D History de la Commande Client" --text "Type D History de la Commande Client";
...
enum add-enum-constant-description --locale fr --onConstant FROZEN_TERMINATED --title "Terminé Gelé" --text "Terminé Gelé";
...
field custom --named procStep --type ~.jpa.ProcStep;
...
enum enumerated-field --onProperty procStep;
constraint NotNull --onProperty procStep;

field custom --named histryType --type ~.jpa.HistoryType;
...
enum enumerated-field --onProperty histryType;
...
description add-field-description --onProperty soNbr --title "Sales Order Number" --text "The sales order number.";
description add-field-description --onProperty soNbr --title "Numéro de Commande Client" --text "Le numéro de la commande client." --locale fr;
constraint NotNull --onProperty recordDate;
...
description add-class-description  --locale fr --title "Persone Impliqué dans une Commande Client" --text "Persone Impliqué dans une Commande Client";
...
@/* InvoiceType */;
java new-enum-type --named SlsInvoiceType --package ~.jpa ;
...
description add-class-description  --locale fr --title "Historique Facture" --text "Historique facture.";
...
field custom --named invceStatus --type ~.jpa.SlsSalesStatus;
...
enum enumerated-field --onProperty invceStatus;
...
field custom --named hstryType --type ~.jpa.HistoryType;
...
enum enumerated-field --onProperty hstryType;
...
@/* Enum type Sales Status */;
java new-enum-type --named SlsInvceStatus --package ~.jpa;
enum add-enum-class-description --title "Sales Status" --text "Status of the invoice";
enum add-enum-class-description --title "Status Vente" --text "Status da la facture" --locale fr;
java new-enum-const SUSPENDED ;
enum add-enum-constant-description --onConstant SUSPENDED --title "Suspended" --text "Suspended";
enum add-enum-constant-description --onConstant SUSPENDED --title "Suspendu" --text "Suspendu" --locale fr ;
...
field custom --named invceType --type ~.jpa.SlsInvceType;
...
enum enumerated-field --onProperty invceType;
...
field custom --named invceStatus --type ~.jpa.SlsInvceStatus;
