(function() {
    ...
    salesUtils.$inject = ['$translate','genericResource','API_BASE_URL', 'BASE_SERVER'];
    /* @ngInject */
    function salesUtils($translate, genericResource, API_BASE_URL, BASE_SERVER) {

        var service = {};

        service.orderManagerUrlBase = API_BASE_URL + "/delivery";
        service.urlBase= API_BASE_URL + '/salesdeliverys';
        service.salessUrlBase= BASE_SERVER+ '/adsales.server/rest/salesdlvryitems';
