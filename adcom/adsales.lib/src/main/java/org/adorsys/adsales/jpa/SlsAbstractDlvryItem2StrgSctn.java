...
public abstract class SlsAbstractDlvryItem2StrgSctn extends CoreAbstIdentifData {

	private static final long serialVersionUID = -4315392509913415004L;

	@Column
	@Description("SlsDelivery_dlvryItemNbr_description")
	@NotNull
	private String dlvryItemNbr;

	@Column
	@Description("SlsDelivery_strgSection_description")
	@NotNull
	...
	public void copyTo(SlsAbstractDlvryItem2StrgSctn target){
	...
	public boolean contentEquals(SlsAbstractDlvryItem2StrgSctn target){
