(function () {
    ...
    var appModule = angular.module('admanager', [
        'app.core',
        'app.layout',
        'smart-table',
        'ui.bootstrap',
    ...
    angular.element(document).ready(function ($http, Auth) {
       ...
       keycloakAuth.init({onLoad: 'login-required'}).success(function () {
            ...
            auth.logoutUrl = keycloakAuth.authServerUrl +
                '/realms/adcom/tokens/logout?redirect_uri=/admanager.client';
           appModule.factory('Auth', function() {
               return auth;
           });
           angular.bootstrap(document, ['admanager']);
       }).error(function () {
    ...
    appModule.controller('GlobalController', function($rootScope, Auth, BASE_ROUTE, genericResource) {
        ...
        $rootScope.appTitle = 'Administration';
