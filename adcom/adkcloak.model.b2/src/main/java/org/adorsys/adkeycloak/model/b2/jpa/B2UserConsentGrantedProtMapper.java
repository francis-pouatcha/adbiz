...
public class B2UserConsentGrantedProtMapper extends AbstractIdentifiableEntity implements B2Entity {
	public static final String ENT_TYPE = "UserConsentGrantedProtMappers";
	...
	public static SingularAttribute<B2PersContent, String> getProtocolMapperIdField(){
	...
	public static SingularAttribute<B2PersContent, String> getUserConsentIdField(){
