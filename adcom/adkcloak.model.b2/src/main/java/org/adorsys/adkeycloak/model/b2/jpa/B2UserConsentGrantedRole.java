...
public class B2UserConsentGrantedRole extends AbstractIdentifiableEntity implements B2Entity {
	public static final String ENT_TYPE = "userConsentGrantedRoles";
