...
public class RealmEntity {
    ...
    @JoinTable(name="KC_REALM_CLIENT", joinColumns={ @JoinColumn(name="REALM_ID") }, inverseJoinColumns={ @JoinColumn(name="CLIENT_ID") })
    ...
    @Column(name="VALUE")
    @CollectionTable(name="KC_REALM_SMTP_CONFIG", joinColumns={ @JoinColumn(name="REALM_ID") })
    protected Map<String, String> smtpConfig = new HashMap<String, String>();

    @OneToMany(fetch = FetchType.LAZY, cascade ={CascadeType.REMOVE}, orphanRemoval = true)
    @JoinTable(name="KC_REALM_DEFAULT_ROLES", joinColumns = { @JoinColumn(name="REALM_ID")}, inverseJoinColumns = { @JoinColumn(name="ROLE_ID")})
    ...
    @ElementCollection
    @Column(name="VALUE")
    @CollectionTable(name="KC_REALM_EVENTS_LISTENERS", joinColumns={ @JoinColumn(name="REALM_ID") })
    protected Set<String> eventsListeners = new HashSet<String>();
    
    @ElementCollection
    @Column(name="VALUE")
    @CollectionTable(name="KC_REALM_ENABLED_EVENT_TYPES", joinColumns={ @JoinColumn(name="REALM_ID") })
    ...
    @ElementCollection
    @Column(name="VALUE")
    @CollectionTable(name="KC_REALM_SUPPORTED_LOCALES", joinColumns={ @JoinColumn(name="REALM_ID") })
