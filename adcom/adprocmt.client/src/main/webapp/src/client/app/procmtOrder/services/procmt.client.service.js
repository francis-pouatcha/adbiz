(function() {
    ...
    function($http,$resource,API_BASE_ADPROCMT_URL){
        ...
        var actions = {
            ...
            listAll:{
                method: 'GET',
                url: API_BASE_ADPROCMT_URL + '/prcmtprocorders',
                params:{
                    start: -1,
                    max: 20
                }
            ...
            get:{
                method: 'GET',
                url: API_BASE_ADPROCMT_URL + '/prcmtprocorders/:identif'
            },
            prepare: {
                method: 'PUT',
                url: API_BASE_ADPROCMT_URL + '/order/prepare/:identif'
            },
            close: {
                method: 'PUT',
                url: API_BASE_ADPROCMT_URL + '/order/:identif/close'
            },
            validate: {
                method: 'PUT',
                url: API_BASE_ADPROCMT_URL + '/order/:identif/validate'
            },
            archive: {
                method: 'PUT',
                url: API_BASE_ADPROCMT_URL + '/order/:identif/archive'
            },
            post: {
                method: 'PUT',
            ...
            updateItem: {
                method: 'PUT',
                url: API_BASE_ADPROCMT_URL + '/order/:identif/items/:itemIdentif'
            },
            disableItem: {
                method: 'PUT',
                url: API_BASE_ADPROCMT_URL + '/order/:identif/items/:itemIdentif/disable'
            },
            enableItem: {
                method: 'PUT',
                url: API_BASE_ADPROCMT_URL + '/order/:identif/items/:itemIdentif/enable'
            },
            updatetrgtQty: {
                method: 'PUT',
                url: API_BASE_ADPROCMT_URL + '/order/:identif/items/:itemIdentif/targetQty'
            }

        };

        var API_URL = API_BASE_ADPROCMT_URL + '/order/:identif';
    ...
    function prcmtUtils($translate, genericResource, API_BASE_ADPROCMT_URL) {
        ...
        service.orderManagerUrlBase = API_BASE_ADPROCMT_URL + "/order";
        service.urlBase= API_BASE_ADPROCMT_URL + '/prcmtprocorders';
        service.procmtsUrlBase=  '/adprocmt.server/rest/prcmtpoitems';
