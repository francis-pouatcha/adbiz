(function() {
    ...
    function prcmtUtils($translate, genericResource, API_BASE_URL, BASE_SERVER) {
        ...
        service.orderManagerUrlBase = API_BASE_URL + "/order";
        service.urlBase= API_BASE_URL + '/prcmtprocorders';
        service.procmtsUrlBase= BASE_SERVER+ '/adprocmt.server/rest/prcmtpoitems';
