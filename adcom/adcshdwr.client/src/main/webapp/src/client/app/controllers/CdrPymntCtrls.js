...
.factory('cdrUtils',['$translate','genericResource','$q',function($translate,genericResource,$q){
    var service = {};
...
.controller('cdrPaymntShowCtlr',['$scope','$location','cdrUtils','cdrState','$rootScope','genericResource',
                                 function($scope,$location,cdrUtils,cdrState,$rootScope,genericResource){
    $scope.cdrPaymnt = cdrState.cdrPaymnt();
    $scope.error = "";
    if($scope.cdrPaymnt) {
