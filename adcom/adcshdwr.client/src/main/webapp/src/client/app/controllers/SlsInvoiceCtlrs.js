...
.factory('cdrSlsInvoicesUtils',['$translate','genericResource','$q', '$http',function($translate,genericResource,$q,$http){
    var service = {};
...
.factory('cdrSlsInvoicesState',['$rootScope','searchResultHandler',function($rootScope,searchResultHandler){
