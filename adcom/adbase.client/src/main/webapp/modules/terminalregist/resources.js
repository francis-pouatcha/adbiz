...
angular.module('AdBase').factory('secTerminalRegistResource',['$http', function($http){
    var service = {};
    var urlBase = '/adbase.server/rest/secterminalregist',
    searchInput = {
        entity:{},
        start:0,
        max:100,
    ...
    service.findAllActiveTerminals = function(entitySearchInput){
        return $http.post(urlBase+'/findAllActiveTerminals',entitySearchInput);
    };
